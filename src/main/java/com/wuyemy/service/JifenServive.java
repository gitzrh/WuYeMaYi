...
public class JifenServive {
	...
	public void subtractChujuJinbiWitnZjmxTal(String zhanghao,BigDecimal jibishu){
		Zijinmingxi zijinmingxi= new Zijinmingxi(null, zhanghao, jibishu, "出局金币","扣除", DateToString.DateToStr(new Date()));
		zijinmingxiMapper.insertSelective(zijinmingxi);
	}
	//插入资金明细表扣除分享金币记录
	public void subtractFxJinbiWitnZjmxTal(String zhanghao,BigDecimal jibishu){
		Zijinmingxi zijinmingxi= new Zijinmingxi(null, zhanghao, jibishu, "分享金币","扣除", DateToString.DateToStr(new Date()));
		zijinmingxiMapper.insertSelective(zijinmingxi);
	}
	//插入资金明细表扣除购车金币记录
	public void subtractGCJinbiWitnZjmxTal(String zhanghao,BigDecimal jibishu){
		Zijinmingxi zijinmingxi= new Zijinmingxi(null, zhanghao, jibishu, "购车金币","扣除", DateToString.DateToStr(new Date()));
		zijinmingxiMapper.insertSelective(zijinmingxi);
	}
	//插入资金明细表增加出局金币记录
	public void addChujuJinbiWitnZjmxTal(String zhanghao,BigDecimal jibishu){
		Zijinmingxi zijinmingxi= new Zijinmingxi(null, zhanghao, jibishu, "出局金币","增加", DateToString.DateToStr(new Date()));
		zijinmingxiMapper.insertSelective(zijinmingxi);
	}
	//插入资金明细表增加分享金币记录
	public void addFxJinbiWitnZjmxTal(String zhanghao,BigDecimal jibishu){
		Zijinmingxi zijinmingxi= new Zijinmingxi(null, zhanghao, jibishu, "分享金币","增加", DateToString.DateToStr(new Date()));
		zijinmingxiMapper.insertSelective(zijinmingxi);
	}
	//插入资金明细表增加购车金币记录
	public void addGCJinbiWitnZjmxTal(String zhanghao,BigDecimal jibishu){
		Zijinmingxi zijinmingxi= new Zijinmingxi(null, zhanghao, jibishu, "购车金币","增加", DateToString.DateToStr(new Date()));
		zijinmingxiMapper.insertSelective(zijinmingxi);
	}
